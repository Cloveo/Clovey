...
using System.Xml;
using CCWin;
using ClyUpdateClient.Properties;

namespace ClyUpdateClient
{
    public partial class ClyUpdateClient : CCSkinMain
    {
        ...
        private string temp = System.AppDomain.CurrentDomain.BaseDirectory + "ClyTemp\\";
        private int CON = 0;
        private int ECON = 0;
        private int SUM = 0;
        private string TotalSize;
        string xmlPath = System.AppDomain.CurrentDomain.BaseDirectory + "ClyFile.xml";
        ...
        private void ClyUpdateClient_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (tr != null)
                tr.Abort();
        }
